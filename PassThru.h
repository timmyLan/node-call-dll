...
int WINAPI PassThru_Ioctl(char* ErrorMessage,unsigned int Index,unsigned long pChannelID,unsigned long IoctlID=SET_CONFIG);
...
int WINAPI PassThru_StopMsgFilter(char* ErrorMessage,unsigned int Index,unsigned long pChannelID,unsigned long pFilterID);
